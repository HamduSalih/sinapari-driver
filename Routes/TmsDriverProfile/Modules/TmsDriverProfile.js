...
export function updateProfile(data){
	var collections = database.collection('tms_drivers').doc(data.driverId.toString());
	if(data.affiliate == 'under_partner'){
		return(dispatch)=>{
			collections.update({
...
export function TmsDriverProfileReducer (state = initialState, action){
